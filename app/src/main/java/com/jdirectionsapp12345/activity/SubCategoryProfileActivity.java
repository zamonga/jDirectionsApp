...
import com.jdirectionsapp12345.adapter.ProfileAdapter;
import com.jdirectionsapp12345.common.Share;
import com.jdirectionsapp12345.model.profile.ProfileDataModel;
...
//        category_id = i.getExtras().getString("id");
        ...
        img_home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(SubCategoryProfileActivity.this, CountryActivity.class);
        ...
        Typeface font = Typeface.createFromAsset(getAssets(), "fonts/Product Sans Regular.ttf");
